<?php
/*
 * wpf_popup_string.php
 * This file contains the code for the  translations of the strings based on PO and MO files.
 */
$wpf_priority_low            = __( 'Low', 'atarim-visual-collaboration' );
$wpf_priority_medium         = __( 'Medium', 'atarim-visual-collaboration' );
$wpf_priority_high           = __( 'High', 'atarim-visual-collaboration' );
$wpf_priority_critical       = __( 'Critical', 'atarim-visual-collaboration' );
$wpf_status_open_task        = __( 'Open', 'atarim-visual-collaboration' );
$wpf_status_in_progress      = __( 'In Prog.', 'atarim-visual-collaboration' );
$wpf_status_pending_review   = __( 'Review', 'atarim-visual-collaboration' );
$wpf_status_complete         = __( 'Comple.', 'atarim-visual-collaboration' );
$wpf_complete_task           = __( 'Complete', 'atarim-visual-collaboration' );
$wpf_completed_task          = __( 'Completed', 'atarim-visual-collaboration' );
$wpf_screenshot_view         = __( 'Screenshot The Current View', 'atarim-visual-collaboration' );
$wpf_comment_box_placeholder = __( 'Leave a comment...', 'atarim-visual-collaboration' );
$wpf_create_task             = __( 'Click to leave a comment', 'atarim-visual-collaboration' );
$wpf_add_comment_btn         = __( 'Comment', 'atarim-visual-collaboration' );
$wpf_mark_internal_btn       = __( 'Mark as internal', 'atarim-visual-collaboration' );
...
$wpf_user_name               = __( 'Created by:', 'atarim-visual-collaboration' );
$wpf_user_ip                 = __( 'User IP:', 'atarim-visual-collaboration' );
$wpf_task_id                 = __( 'Task ID:', 'atarim-visual-collaboration' );
$wpf_delete_ticket           = __( 'Delete task', 'atarim-visual-collaboration' );
$wpf_delete_conform_text1    = __( 'Better to change the status to complete.', 'atarim-visual-collaboration' );
$wpf_delete_conform_text2    = __( 'Are you sure you want to delete?', 'atarim-visual-collaboration' );
$wpf_yes                     = __( 'Yes', 'atarim-visual-collaboration' );
$wpf_general_tag             = __( 'General', 'atarim-visual-collaboration' );
$wpf_email_tag               = __( 'Email', 'atarim-visual-collaboration' );
$wpf_just_now                = __( 'now', 'atarim-visual-collaboration' );
$wpf_send_message_text       = __( 'Comment', 'atarim-visual-collaboration' );
$wpf_by                      = __( 'by ', 'atarim-visual-collaboration' );
$wpf_additional_information  = __( 'Additional Information', 'atarim-visual-collaboration' );
$wpf_custom_tags             = __( 'Custom Tags', 'atarim-visual-collaboration' );
$wpf_share_task_link         = __( 'Share Task Link :', 'atarim-visual-collaboration' );
$wpf_remove_login_parameter  = __( 'Remove Login Parameter', 'atarim-visual-collaboration' );
$wpf_bulk_editing_tasks      = __( 'Bulk Editing Tasks', 'atarim-visual-collaboration' );
$wpf_tasks_found             = __( 'Tasks Found', 'atarim-visual-collaboration' );
$wpf_general_task_option     = __( 'General Task: Choose a page/post to comment', 'atarim-visual-collaboration' );
$wpf_remap_text              = __( 'Remap the task to other element', 'atarim-visual-collaboration' );
$create_internal_task        = __( 'Add comment and create Internal task', 'atarim-visual-collaboration' );
